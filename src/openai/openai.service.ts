...
1. 학습 내용을 Markdown 포맷으로 정리 (refinedContent)
2. 기술적으로 잘못된 부분을 검증 (factChecks)
3. 사용자의 기술 수준을 반영한 피드백 제공 (feedback)
4. Actionable Todo를 제안하여 발전 방향을 제시 (suggestedTodos)
5. 스킬 트리 업데이트 제안 (666)
